  ...
  return (
    <>
      <div className='main--container-buttons'>
        <button>
          <span className='icon-add-outline'></span>Add Organizator
        </button>
      ...
      <div className='second--main'>
        <div className='second--main-table'>
          ...
          <p>Email</p>
          <img
            src='./Images/icons/ajustes.svg'
            alt='configuration'
            className='icon-ajustes'
          />
        </div>
        <div className='second--main-content'>
          <div className='second--main-details'>
            ...
            <div>
              <a href='#'>
                <img
                  src='./Images/icons/crear-nuevo-boton-de-lapiz.svg'
                  alt='icon_edit'
      ...
      <div className='show--details'>
        ...
        <div>
          <button>
            <img
              src='./Images/icons/boton-de-flecha-izquierda-del-teclado.svg'
              alt=''
              className='icon-details'
            />
          </button>
          ...
          <button>
            <img
              src='./Images/icons/flecha-derecha.svg'
              alt=''
              className='icon-details'
            />
          </button>
